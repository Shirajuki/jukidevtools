...
export const Route = createLazyFileRoute("/_web/javascript-formatter")({
...
function JavaScriptFormatter() {
	...
	return (
		<InputOutputLayout
			...
			OutputView={<CodeEditor code={formattedJs} language="javascript" readonly />}
		/>
	);
}

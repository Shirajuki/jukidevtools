...
import compressImage from "../../utils/image/compressImage.utils";
import { createLazyFileRoute } from "@tanstack/react-router";

export const Route = createLazyFileRoute("/_image/image-compressor")({
				...
				>
					...
					>
						<div className="flex gap-4">
							<div className="grow">
								<Slider min={1} max={10} value={options.level} onChange={onLevelChange} />
							</div>
							...
							text={
								<>
									{output.compressedSize >= output.originalSize ? (
										...
										<>
											Saving:{" "}
											{100 - Math.floor((output.compressedSize * 100) / output.originalSize)}
											%
											<br />
										</>
									)}

...
import { Button, Space, Radio, type RadioChangeEvent } from "antd";
...
export const Route = createLazyFileRoute("/_encoding/backslash-escape-unescape")({
...
function BackslashEscapeUnescape() {
	...
	return (
		<InputOutputLayout
			...
			OutputView={<CodeEditor code={processedText} language="text" readonly />}
		/>
	);
}

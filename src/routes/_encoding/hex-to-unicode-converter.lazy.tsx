...
export const Route = createLazyFileRoute("/_encoding/hex-to-unicode-converter")({
	component: HexToUnicodeConverter,
});
export interface IOptionTypes {
	hex: string;
}

function HexToUnicodeConverter() {

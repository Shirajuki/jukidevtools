...
import { type Name, X509Certificate } from "@peculiar/x509";
...
export const Route = createLazyFileRoute("/_encoding/digital-certificate-decoder")({
	component: DigitalCertificateDecoder,
});
...
function DigitalCertificateDecoder() {
	...
	return (
		<InputOutputLayout
			...
			InputView={
				<CodeEditor
					ref={codeEditorRef}
					code={options.current.certificate}

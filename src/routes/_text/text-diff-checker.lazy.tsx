...
export const Route = createLazyFileRoute("/_text/text-diff-checker")({
...
function TextDiffChecker() {
	...
	const generateSample = () => {
		if (originalTextEditorRef.current === null || changedTextEditorRef.current === null) return;
			...
			View={
				<Form form={form} layout="vertical" size="large" requiredMark="optional">
					<div className="w-full flex flex-col md:flex-row gap-8">
						<Form.Item<IOptionTypes> label="Original text" required={true} className="basis-0 grow">
							<div className="h-[250px]">
								<CodeEditor
									ref={originalTextEditorRef}
									code={options.current.originalText}
									language="text"
						...
						<Form.Item<IOptionTypes> label="Changed text" required={true} className="basis-0 grow">
							<div className="h-[250px]">
								<CodeEditor
									ref={changedTextEditorRef}
									code={options.current.changedText}
									language="text"
									onChange={onChangedTextChange}
								/>
							</div>
						</Form.Item>
					</div>

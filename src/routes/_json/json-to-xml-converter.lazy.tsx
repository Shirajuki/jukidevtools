...
export const Route = createLazyFileRoute("/_json/json-to-xml-converter")({
...
function JsonToXmlConverter() {
	...
	return (
		<InputOutputLayout
			...
			OutputView={<CodeEditor code={convertedXml} language="xml" readonly />}
		/>
	);
}

...
export const Route = createLazyFileRoute("/_json/yaml-to-json-converter")({
	component: YamlToJsonConverter,
});
...
function YamlToJsonConverter() {
	...
	return (
		<InputOutputLayout
			...
			OutputView={<CodeEditor code={convertedJson} language="json" readonly />}
		/>
	);
}

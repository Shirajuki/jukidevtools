...
export const Route = createLazyFileRoute("/_json/json-to-yaml-converter")({
...
function JsonToYamlConverter() {
	...
	return (
		<InputOutputLayout
			...
			OutputView={<CodeEditor code={convertedYaml} language="yaml" readonly />}
		/>
	);
}

...
const InputOutputLayout: FC<IInputOutputLayoutProps> = ({
	InputToolbar,
	InputView,
	OutputToolbar,
	OutputView,
	...
	return (
		<div className="flex flex-col lg:flex-row h-full">
			<div className="basis-0 flex-grow h-auto lg:h-full flex flex-col">
				...
				<div className="flex-grow overflow-y-auto px-8 pb-8">{InputView}</div>
			</div>
			...
			<div className="basis-0 flex-grow h-auto lg:h-full flex flex-col">
				...
				<div className="flex-grow overflow-y-auto px-8 pb-8 flex flex-col">{OutputView}</div>
			</div>
		</div>
	);
};

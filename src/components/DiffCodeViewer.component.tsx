import { type MutableRefObject, forwardRef, useEffect, useMemo, useRef } from "react";
...
const DiffCodeViewer = forwardRef<monaco.editor.IStandaloneDiffEditor, IDiffCodeViewerProps>(
	({ original, modified, language, className }, ref) => {
		...
		useEffect(() => {
			if (original === null || modified === null || editorRef.current === null) return;
		...
		}, [original, modified, language, editor, theme, wordWrap]);
